...
function Meteor:new(x)
	local meteor = display.newImage("graphics/meteor.png")
  --meteor.midx = x
  --meteor.midy = y
  ...
  function meteor:destroy()
    ...
    local burningMeteor = display.newImage("graphics/meteor_destroyed.png")
    burningMeteor.xScale = self.xScale
    burningMeteor.yScale = self.yScale   
  ...
  function meteor:hitGround()
    ...
    local meteorExplosion = display.newImage("graphics/meteor_impact.png")
    ...
    meteorExplosion.xScale = self.xScale * 2
    meteorExplosion.yScale = self.yScale * 2  
    meteorExplosion.x = self.x
    meteorExplosion.y = groundY + 20
    meteorExplosion:setReferencePoint(display.BottomCenterReferencePoint)
    meteorExplosion.y = groundY + 20
